...
const constants = {
  ...
  API_AUTHENTICATION_RECEIVED: 'apiAuthenticationReceived',
  API_SCHEMA_RECEIVED: 'apiSchemaReceived',
  API_MODELS_RECEIVED: 'apiModelsReceived',
  API_REFERENCES_RECEIVED: 'apiReferencesReceived',
  API_QUERY: 'apiQuery',
  API_RECEIVE: 'apiReceive',

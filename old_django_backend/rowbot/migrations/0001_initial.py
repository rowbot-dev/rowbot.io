# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-12-16 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('is_active', models.BooleanField(default=True)),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='socket_tokens', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'permissions': (),
            },
